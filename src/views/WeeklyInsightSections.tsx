...
export function WeeklyInsightHeader({ summary }: SectionProps) {
  return (
    <>
...
export function WeeklyInsightHeadline({ summary }: SectionProps) {
  return (
...
export function WeeklyInsightStats({ summary }: SectionProps) {
  ...
  return (
    <View className="grid-cols-2 flex-row gap-2 px-6 pb-8">
      ...
      <View className="flex-1 rounded-2xl border border-warm3 bg-paper px-3.5 py-3.5">
        ...
        <Text className="mt-2 text-base font-semibold text-warm">{summary.skippedPercent}%</Text>
...
export function WeeklyInsightPatterns({ summary }: SectionProps) {
...
export function WeeklyInsightSuggestions({ summary }: SectionProps) {
...
export function WeeklyInsightFooter({ summary, onOptimizeTomorrow }: FooterProps) {
  return (
    <View className="px-6">
      <PillActionButton
